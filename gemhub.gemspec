...
Gem::Specification.new do |s|
  ...
  s.files = ["app_generators/gemhub", "app_generators/gemhub/gemhub_generator.rb", "app_generators/gemhub/templates", "app_generators/gemhub/templates/lib", "app_generators/gemhub/templates/lib/template.rb.erb", "app_generators/gemhub/templates/Rakefile.erb", "app_generators/gemhub/templates/README.textile", "app_generators/gemhub/templates/spec", "app_generators/gemhub/templates/spec/template_spec.rb.erb", "bin/gemhub", "lib/gemhub.rb", "Rakefile", "README.textile"]
